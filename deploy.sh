...
cp "output/大型數據分析報告_APA7.docx"     docs/large-scale-data-analysis-report-APA7.docx
touch docs/.nojekyll                   # 關閉 Jekyll，避免底線開頭的檔案被忽略

printf '   docs/index.html                      %s\n' "$(du -h docs/index.html | cut -f1)"
printf '   docs/large-scale-data-analysis-report-APA7.docx  %s\n' "$(du -h docs/large-scale-data-analysis-report-APA7.docx | cut -f1)"
